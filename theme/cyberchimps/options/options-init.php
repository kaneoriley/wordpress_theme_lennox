...
function cyberchimps_load_scripts() {
	...
	wp_enqueue_script( 'jquery-touch-punch-min', $directory_uri . '/cyberchimps/lib/js/touch-punch.js', array( 'jquery' ) );
	wp_enqueue_script( 'jquery-touch-sense', $directory_uri . '/cyberchimps/lib/js/touch-sensitive.js', array( 'jquery' ) );

	wp_enqueue_script( 'thickbox' );
	wp_enqueue_script( 'color-picker', $directory_uri . '/cyberchimps/options/lib/js/colorpicker.js', array( 'jquery' ), '', true );
	wp_enqueue_script( 'media-uploader', $directory_uri . '/cyberchimps/options/lib/js/options-medialibrary-uploader.js', array( 'jquery' ), '', true );
	wp_enqueue_script( 'options-custom', $directory_uri . '/cyberchimps/options/lib/js/options-custom.js', array( 'jquery' ), '', true );
	wp_enqueue_script( 'bootstrap-js', $directory_uri . '/cyberchimps/lib/bootstrap/js/bootstrap.js', array( 'jquery' ), '', true );
	wp_enqueue_script( 'google-fonts', $directory_uri . '/cyberchimps/options/lib/js/font_inline_plugin.js', array( 'jquery' ), '', true );
}
